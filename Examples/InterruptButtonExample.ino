...
void setup() {
  ...
  button1.keyPress[0] =           &menu0Button1keyPress;        // Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!         
  button1.longKeyPress[0] =       &menu0Button1longKeyPress; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
  button1.doubleClick[0] =        &menu0Button1doubleClick; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
  ...
  button2.keyPress[0] =           &menu0Button2keyPress;        // Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!   
  button2.longKeyPress[0] =       &menu0Button2longKeyPress; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
  button2.doubleClick[0] =        &menu0Button2doubleClick; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
  ...
  button1.keyPress[1] =           &menu1Button1keyPress;        // Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!         
  button1.longKeyPress[1] =       &menu1Button1longKeyPress; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
  button1.doubleClick[1] =        &menu1Button1doubleClick; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
  ...
  button2.keyPress[1] =           &menu1Button2keyPress;        // Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!        
  button2.longKeyPress[1] =       &menu1Button2longKeyPress; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
  button2.doubleClick[1] =        &menu1Button2doubleClick; 		// Asynchronous, fires as an interrupt so should be IRAM_ATTR and be FAST!
...
void IRAM_ATTR menu1Button2longKeyPress(void) { Serial.println("Menu 1, Button 2: Async Long Key Press"); } 
